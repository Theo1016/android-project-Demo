...
public class RequestParams {
    ...
    public void add(String key, String value,boolean notuse) {
        if (key != null && value != null) {
            Object params = urlParamsWithObjects.get(key);
            if (params == null) {
        ...
        System.out.println(urlParamsWithObjects.toString());
    }
    /**
    ...
    public HttpEntity getEntity(ResponseHandlerInterface progressHandler) throws IOException {
        if (useJsonStreamer) {
        	HttpEntity en = createJsonStreamerEntity(progressHandler);
            return en;
